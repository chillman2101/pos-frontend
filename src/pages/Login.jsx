    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-neutral-900 mb-2">POS System</h1>
        ...
        <div className="mt-6 bg-primary-50 rounded-lg p-4 border border-primary-200">
          <p className="text-xs font-semibold text-primary-900 mb-2">Login Credentials:</p>
          <div className="text-xs text-primary-800 space-y-1">
            <p><span className="font-semibold">Username:</span> chillman2101</p>
            <p><span className="font-semibold">Password:</span> aditgr2101</p>
          </div>
        </div>
      </div>
    </div>
